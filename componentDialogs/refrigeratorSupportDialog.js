...
const frCard = require('../resources/adaptiveCards/frCard'); 
const CARDS = [
...
class RefrigeratorSupportDialog extends ComponentDialog {
    
    constructor(conservsationState,userState) {
        super('refrigeratorSupportDialog');
...
return await step.prompt(CONFIRM_PROMPT, 'Would you like to Continue with Refrigerator Support?', ['yes', 'no']);
...
return await step.prompt(CHOICE_PROMPT,'Please choose the Support From the listed below', ['NewInstallationDemo','ForRegisterNewRepair','ExtendedWarranty']);
    ...
    { 
        await step.context.sendActivity("You chose not to go ahead with Refrigerator Support.");
        endDialog = true;
...
module.exports.RefrigeratorSupportDialog = RefrigeratorSupportDialog;
